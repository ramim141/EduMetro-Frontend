...
//     const baseClasses = "w-full bg-white border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500";
...
//       {label && (
//         <label 
//           className={`block mb-1 font-medium text-gray-700 dark:text-gray-300 ${sizeClasses} ${disabled ? 'opacity-60' : ''}`}
//         >
//           {label}
...
//           {...props}
//         >
//           <option key="placeholder" value="">{placeholderText}</option>
...
const Dropdown = ({
  ...
  const getVariantClasses = () => {
    const baseClasses =
      "w-full bg-white border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
    const variantClasses =
      {
        default: "border-gray-300",
        error: "border-red-500",
